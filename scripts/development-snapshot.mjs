...
import {rateDevelopment} from '../dist/development.js';
...
const queue=process.argv.includes('--missing')?entries.filter(([id])=>rateDevelopment(output[id]).score===null):[...entries];
